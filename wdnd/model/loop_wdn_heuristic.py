...
class WaterNetworkOptimizer:
    ...
    def iterate_arc(self, iteration, improved, best_arc):
        ...
        for node in  self.sorted_nodes:
            ...
            for edge in sorted_all_arcs:
                ...
                self.update_initial_points(edge, l_lp, q_lp, h_lp) 
    ...
    def solve(self):
        ...
        self.ampl.set_option("ipopt_options", f"outlev = 0 expect_infeasible_problem = yes  bound_relax_factor=0")   #max_iter = 1000
