...
#
# ampl.eval("s.t. z12: z1[1,2] = 1;")
# ampl.eval("s.t. z23: z1[2,3] = 1;")
# ampl.eval("s.t. z24: z1[2,4] = 1;")
# ampl.eval("s.t. z35: z1[3,5] = 0;")
# ampl.eval("s.t. z45: z1[4,5] = 1;")
# ampl.eval("s.t. z56: z1[4,6] = 1;")
# ampl.eval("s.t. z67: z1[6,7] = 0;")
# ampl.eval("s.t. z75: z1[7,5] = 0;")
#
# ampl.eval("s.t. z_12: z2[1,2] = 0;")
# ampl.eval("s.t. z_23: z2[2,3] = 0;")
# ampl.eval("s.t. z_24: z2[2,4] = 0;")
# ampl.eval("s.t. z_35: z2[3,5] = 1;")
# ampl.eval("s.t. z_45: z2[4,5] = 0;")
# ampl.eval("s.t. z_56: z2[4,6] = 0;")
# ampl.eval("s.t. z_67: z2[6,7] = 1;")
# ampl.eval("s.t. z_75: z2[7,5] = 1;")
