...
class WaterNetworkOptimizer:
    ...
    def iterate_arc(self,best_acyclic_flow, improved, current_cost, l, q, h, print_str):
        improved = False
                ...
                if nx.is_directed_acyclic_graph(self.network_graph):
                    ...
                    if check_in_degree:
                        ...
                        if self.solve_result == " solved ":
                            print_str +=  str(self.solve_result)
                            print_str +=  str(current_cost)
                            print_str +=  str(self.total_cost)
        ...
        return best_acyclic_flow, improved, current_cost, l, q, h, print_str
    ...
    def iterate_acyclic_flows(self):
        ...
        best_acyclic_flow = self.network_graph.copy()
        int_str = 'Iteration   arc   cyclicity   in_arc > 0 solve_result   old_obj  new_obj  improved '
        print(int_str)
        ...
        while improved:
            ...
            print_str = print_str + str(iteration)
            
            best_acyclic_flow, improved, current_cost, l, q, h, print_str = self.iterate_arc(best_acyclic_flow, improved, current_cost, l, q, h, print_str)
            print(print_str)
