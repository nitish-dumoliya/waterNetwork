...
### CONSTRAINTS ###
s.t. con1{(i,j) in arcs}: h_lp[i] - h_lp[j] = ((q_lp[i,j] + del_q[i,j]) * abs(q_lp[i,j] + del_q[i,j])^0.852 ) * (0.001^1.852) * sum{k in pipes } omega * l_lp[i,j,k] / ( (R[k]^1.852) * (d[k]/1000)^4.87);
